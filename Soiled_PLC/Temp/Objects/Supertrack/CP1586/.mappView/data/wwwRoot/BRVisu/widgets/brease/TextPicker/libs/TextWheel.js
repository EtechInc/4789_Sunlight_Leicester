        ...
        if (this.settings.dataProvider !== undefined) {
            ...
            for (var j in this.settings.dataProvider) {
                ...
                if (this.settings.imagePath === '') {
                    item = $('<div data-index="' + index + '" data-value="' + this.settings.dataProvider[j].value + '"><span>' + textToShow + '</span></div>');
                } else {
                    if (this.settings.imageAlign === 'left') {
                        item = $('<div data-index="' + index + '" data-value="' + this.settings.dataProvider[j].value + '"><img src="' + this.settings.dataProvider[j].image + '"></img><span>' + textToShow + '</span></div>');
                    } else if (this.settings.imageAlign === 'right') {
                        item = $('<div data-index="' + index + '" data-value="' + this.settings.dataProvider[j].value + '"><span>' + textToShow + '</span><img src="' + this.settings.dataProvider[j].image + '"></img></div>');
                    }
                }
